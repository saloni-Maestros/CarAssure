...
public class LatestBidModel {
    public String id="",name="",image="",path="",price="",location="",km_driven="",model="",automatic="",accidental="",car_number="",favourite="",start_time = "",end_time = "";
